...
| **Savings rate used for "required salary"** | The % of your salary you *want* to save — used only for the "Required monthly salary today" metric, not the retirement/corpus calculations. It answers: "if I want to save this % of my income, what salary do I need to also cover my current expenses?" It's a personal target you set, not something the tool calculates for you — see the worked example below. |
...
**Worked example for "Required salary today"** — with the default 25% savings rate and ₹60,000/month expenses:
```
Required salary = 60,000 ÷ (1 − 0.25) = 60,000 ÷ 0.75 = ₹80,000/month
```
That means: earn ₹80,000, save ₹20,000 (25% of 80,000), spend the remaining ₹60,000 — expenses and savings add up to exactly the salary.
