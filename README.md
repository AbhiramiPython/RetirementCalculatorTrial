...
- **Total column/figure** = (the monthly amount you set, grown at that option's/blend's rate) **+** (your current retirement savings from "Your basics", grown at that same rate over the same years)
